...
This code works best with a CUDA GPU-equipped computer, e.g., NVIDIA RTX4090 or A5000; alternatively ORIN 64GB developer kit. Adapt to CPU-only pytorch if intended.
